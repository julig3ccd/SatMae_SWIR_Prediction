...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_type', default=None, choices=['group_c', 'temporal', 'vanilla','shallow_unet'],
    ...
    parser.add_argument('--center_mask', action='store_true', default=False, help="Will mask only center patches")
